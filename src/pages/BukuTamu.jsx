            ...
            <tbody>
                {[...Array(rowCount)].map((_, index) => (
                    <tr key={index} className="border-b border-gray-200">
                        ...
                        <td className="px-3 py-3"><div className="h-4 bg-gray-200 rounded w-1/2"></div></td>
                        <td className="px-3 py-3"><div className="h-4 bg-gray-200 rounded"></div></td>
                    </tr>
                ))}
            </tbody>
...
const BukuTamu = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div className="relative w-full md:w-80">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 border rounded-lg w-full focus:ring-2 focus:ring-sky-500 outline-none"
                    />
                </div>
                <button
                    onClick={() => alert("Navigate to Tambah Buku Tamu page")} // Aksi ini mungkin navigasi ke halaman form terpisah
                    className="bg-sky-600 text-white px-4 py-2.5 rounded-lg hover:bg-sky-700 transition flex items-center justify-center shadow-md"
                >
            ...
            {loading ? (
                <LoadingTable rowCount={bukuTamu.length > 0 ? Math.min(bukuTamu.length, rowsPerPage) : rowsPerPage} />
            ) : (
