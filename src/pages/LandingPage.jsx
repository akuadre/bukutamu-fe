    ...
    <div className="bg-gray-50 text-gray-800 font-sans">
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <div 
              ...
              style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.3) 0%, transparent 40%)' }} 
            />
            ...
            <div className="absolute top-40 right-32 w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full opacity-25 float-animation" style={{ animationDelay: '1s' }} />
            <div className="absolute bottom-32 left-40 w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-500 rotate-45 opacity-15 drift" style={{ animationDelay: '2s' }} />
          </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-white/20 hover:border-white/40 transition-all duration-300">
                    ...
                    <div className="relative aspect-video rounded-xl overflow-hidden shadow-xl">
                      <iframe 
                        ...
                        src="https://www.youtube.com/embed/j-vz3ZuL3jw?autoplay=1&mute=1&controls=0&loop=1&playlist=j-vz3ZuL3jw" 
                    ...
                    <p className="text-sm text-blue-200 text-center mt-4">
                      Tonton video profil sekolah kami untuk mengetahui lebih lanjut
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-slate-800 text-white text-center py-8 border-t border-slate-700">
        <p className="text-gray-300">
          © {new Date().getFullYear()} Buku Tamu Digital. Development by Software Engineer SMKN 1 Cimahi.
        </p>
      </footer>
