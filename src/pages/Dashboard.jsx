    ...
    const fetchDashboard = async () => {
      try {
        ...
        setStats({
          ...
          totalOrangtua: data.stats.totalOrangtua,
          totalJabatan: data.stats.totalJabatan,
          totalPegawai: data.stats.totalPegawai,
          totalBukuTamu: data.stats.totalBukuTamu,
        });

        setRecentGuests(data.recentGuests);

        // Chart dummy dulu (bisa diganti nanti kalo backend kirim data chart)
          ...
          >
            ...
            >
              <h2 className="text-xl font-bold text-gray-800 flex items-center mb-4">
                <UserCheck className="w-6 h-6 mr-2 text-green-500" /> Tamu
                Terbaru
              </h2>
              <div>
